...
<body>
  ...
  <div class="layout">
    <nav class="sidebar no-transition" id="sidebarNav">
      ...
      <a href="xml.php" class="active"><?php include '../assets/images/backup.svg'; ?> <span>Backup and Restore</span></a>
      ...
      <div class="form-container">
        ...
        <div class="backup-grid">
          <div class="form-section">
            ...
            <form action="../api/export_all.php" method="POST">
          ...
          <div class="form-section">
            ...
            <form action="../api/export_tables.php" method="POST">
              <button type="submit" class="submit-btn">
                Export XML Files
              </button>
            </form>
