...
<body>
  ...
  <div class="layout">
    <nav class="sidebar no-transition" id="sidebarNav">
      ...
      <a href="dashboard.php" class="active"><?php include '../assets/images/dashboard.svg'; ?> <span>Dashboard</span></a>
  ...
  <script>
    ...
    async function loadDashboardGraph() {
      ...
      const response = await fetch(`../api/api_dashboard_graph.php?range=${range}&start_date=${start}&end_date=${end}`);
