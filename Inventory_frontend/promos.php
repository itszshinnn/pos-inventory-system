...
<body>
  ...
  <div class="layout">
    <nav class="sidebar no-transition" id="sidebarNav">
      ...
      <a href="promos.php" class="active"><?php include '../Images/promos.svg'; ?> <span>Promo Codes</span></a>
      ...
      <a href="users.php"><?php include '../Images/users.svg'; ?> <span>Accounts</span></a>
  ...
  <script>
    ...
    async function loadPromos() {
      const res = await fetch('../Inventory_backend/api_promos.php');
