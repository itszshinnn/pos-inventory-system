...
<body>
  ...
  <div class="layout">
    ...
    <?php if (isset($errorMsg)): ?>
        <div style="background: #fff0f0; border: 1px solid #ffbcbc; color: #ff4b4b; padding: 12px; border-radius: 8px; margin-bottom: 20px;">
    ...
    <div class="history-toolbar">
        ...
        <select id="sortFilter" onchange="filterUserTable()">
